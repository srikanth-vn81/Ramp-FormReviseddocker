                ...
                if (siteIndex <= countrySiteCounts[country]) {
                    ...
                    cell.innerHTML = `
                        <div class="d-flex flex-column gap-1" style="align-items: center;">
                            ...
                            <input type="number" class="form-control form-control-sm" min="0" placeholder="0" style="max-width: 80px;" title="Headcount">
                            ...
                            <input type="number" class="form-control form-control-sm lead-time" min="0" placeholder="Days" style="max-width: 80px;" title="Lead Time to Hire (Days)">
                            <input type="number" class="form-control form-control-sm weekly-capacity" min="0" placeholder="Weekly" style="max-width: 80px;" title="Weekly Hiring Capacity">
                            <input type="number" class="form-control form-control-sm monthly-capacity" min="0" placeholder="Monthly" style="max-width: 80px;" title="Monthly Hiring Capacity">
                        </div>
                    `;
                } else {
                    cell.textContent = '-';
